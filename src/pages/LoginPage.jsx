...
const LoginPage = () => {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen w-screen bg-cover bg-center" style={{ backgroundImage: "url('/assets/bg.png')", fontFamily: 'Italiana, serif' }}>
      ...
      {/* Login Box */}
      <div className="w-full max-w-sm p-8 bg-transparent border-none shadow-none bg-opacity-70 backdrop-blur-md rounded-lg shadow-lg text-white flex flex-col justify-center">
        <h2 className="text-center text-4xl text-white mb-7" style={{ fontFamily: 'Italiana, serif' }}>Login</h2>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              className="w-[120px] py-2 bg-white transition-all text-black rounded-lg shadow-md"
